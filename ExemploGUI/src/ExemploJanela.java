...
public class ExemploJanela extends JFrame {
    ...
    private JButton jButtonLimpar2 = new JButton("Limpar 2");
    private JTextField jTextFieldTexto = new JTextField("Teste", 20);
    private JTextField jTextFieldTexto2 = new JTextField("Novo Teste", 20);
    private JLabel jLabelMensagem = new JLabel("Exemplo Simples de Janela");
    private JLabel jLabelInformacao = new JLabel("26/03/2024");
    ...
    public ExemploJanela() {
        ...
        painel.add(jButtonLimpar2);
        painel.add(jLabelMensagem);
        painel.add(jLabelInformacao);
        ...
        jButtonLimpar2.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                limparTela2();
            }
        });
